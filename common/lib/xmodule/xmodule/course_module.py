...
class CourseSummary(object):
    ...
    def __init__(self, course_locator, display_name="Empty", display_coursenumber=None, display_organization=None):
        ...
        :param course_locator: CourseLocator object of the course.
        :param display_name: display name of the course. When you create a course from console, display_name
            ...
            set to None.
        :param display_coursenumber: Course number that is specified & appears in the courseware
        :param display_organization: Course organization that is specified & appears in the courseware
