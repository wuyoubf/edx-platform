class @Problem
  ...
  disableAllButtonsWhileRunning: (operationCallback, isFromCheckOperation) =>
    ...
    #   'isFromCheckOperation' is a boolean to keep
    #    track if 'operationCallback' was @check.
  ...
  enableAllButtons: (enable, isFromCheckOperation) =>
    ...
    if enable
      ...
      if isFromCheckOperation
        ...
        @enableCheckButton enable, false
    else
      @resetButton
        .add(@saveButton)
        .add(@hintButton)
  ...
  enableCheckButton: (enable, changeText = true) =>
    ...
    # params:
    #   'enable' is a boolean to determine enabling/disabling of @checkButton.
    #   'changeText' is a boolean to determine if there is need to change the
    #    text of @checkButton as well.
    if enable
