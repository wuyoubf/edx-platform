...
class ProblemTypeTestBase(ProblemsTest):
    """
...
class ProblemTypeTestMixin(object):
    ...
    def test_answer_correctly(self):
        ...
        expected_events = [
            {'event_source': 'server', 'event_type': 'problem_check'},
            {'event_source': 'browser', 'event_type': 'problem_check'},
        ]
